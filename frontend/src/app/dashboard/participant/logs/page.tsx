        ...
        <div className="space-y-8">
            ...
            <div className="glass p-8 rounded-3xl border border-white/5 bg-slate-900/40 relative overflow-hidden group">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <button className="ml-auto flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white px-4 py-2 rounded-xl text-[13px] font-bold uppercase tracking-wider transition-all">
                ...
                <div className="border-t border-white/5 pt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center group-hover:bg-slate-800/50 p-3 rounded-lg transition-colors">
                        <div className="text-[13px] text-slate-500 mb-1">Dose</div>
                        <div className="font-bold text-white">500mg</div>
                    </div>
                    <div className="text-center group-hover:bg-slate-800/50 p-3 rounded-lg transition-colors">
                        <div className="text-[13px] text-slate-500 mb-1">Time Taken</div>
                        <div className="font-bold text-emerald-400">08:00 AM</div>
                    </div>
                    <div className="text-center group-hover:bg-slate-800/50 p-3 rounded-lg transition-colors">
                        <div className="text-[13px] text-slate-500 mb-1">Adherence</div>
                        <div className="font-bold text-cyan-400">100%</div>
                    </div>
                    <div className="text-center group-hover:bg-slate-800/50 p-3 rounded-lg transition-colors">
                        <div className="text-[13px] text-slate-500 mb-1">Missed Dose?</div>
            ...
            <div className="glass p-8 rounded-3xl border border-white/5 bg-slate-900/40 relative overflow-hidden group">
                ...
                <div className="flex justify-between text-[13px] text-slate-600 uppercase font-black tracking-widest mt-2 px-2">
                    <span>Very Low</span>
                    <span>Excellent</span>
                </div>
            </div>
            ...
            {/* Adverse Event Log */}
            <Link href="/dashboard/participant/logs/ae-report">
